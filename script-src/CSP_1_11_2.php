...
<html>
	...
	<script src="<?php echo $_GET['protocol'] . '//www.' . $_SERVER['HTTP_HOST'] . substr($_SERVER['SCRIPT_NAME'], 0, strpos($_SERVER['SCRIPT_NAME'], basename($_SERVER['SCRIPT_NAME']))) ?>../support/success.php"></script>
        ...
        <script src="<?php echo $_GET['protocol'] . '//www.' . $_SERVER['HTTP_HOST'] . substr($_SERVER['SCRIPT_NAME'], 0, strpos($_SERVER['SCRIPT_NAME'], basename($_SERVER['SCRIPT_NAME']))) ?>../support/buildBlobEval.php"></script>
