...
$title = "Script created from inline text and loaded via blob URI should not run with policy \"$policy_string\".";
...
<html>
	...
	<script id="inlineEvil" type="evil">
 	...
 	test(function() {assert_false(true)}, "Inline script ran.");
